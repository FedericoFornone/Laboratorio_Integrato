...
def main(region, infrastructure, residence):
    ...
    df_train_attendance = df_train['Attendance']
    df_test_attendance = df_test['Attendance']
    ...
    forecaster.fit(y=df_train_attendance)
    ...
    fa_autoreg.fit(y=df_train_attendance)
